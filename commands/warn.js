...
const fs = require("fs");
const warns = JSON.parse(fs.readFileSync("./data/warnigs.json", "utf8"));

module.exports.run = async(bot, message, args) =>{

   if (!message.member.me.hasPermission("MANAGE_MESSAGES")) return message.reply("sorry jij kan dit niet");
